...
#
# Script generated by Vivado on Fri Aug 28 05:41:22 -0600 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RISC_V_tb.sh
...
#
# Usage        : RISC_V_tb.sh
#                RISC_V_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RISC_V_tb.sh [-rerun]
#                RISC_V_tb.sh [-reset_run]
#                RISC_V_tb.sh [-clean]
#                RISC_V_tb.sh [-reset_log]
#                RISC_V_tb.sh [-help]
#
...
#                script (type 'RISC_V_tb.sh -help' for more information).
#
...
#
#**********************************************************************************************************
set SIM_VER_QUESTA=2049.1
set GCC_VER_QUESTA=7.4.0

# catch pipeline exit status
set -Eeuo pipefail

# Set simulator install path
export bin_path=C:\Users\trist\.vscode\extensions\sigasi.sigasi-visual-hdl-2026.3.2026080708-win32-x64\packages\buildUtils\dist\server\com.sigasi.hdt.toolchains.stubs\compilers\bin\windows

# simulation root library directory
sim_lib_dir="questa_lib"

# script info
echo -e "RISC_V_tb.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RISC_V_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
simulate()
{
  $bin_path/vsim   -c -do "do {simulate.do}" -l simulate.log
}
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/RISC_V_research/RISC_V/RISC_V.cache/compile_simlib/questa"
  fi
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RISC_V_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RISC_V_tb.sh [-help]\n\
Usage: RISC_V_tb.sh [-step]\n\
Usage: RISC_V_tb.sh [-lib_map_path]\n\
Usage: RISC_V_tb.sh [-rerun]\n\
Usage: RISC_V_tb.sh [-reset_run]\n\
Usage: RISC_V_tb.sh [-clean]\n\
Usage: RISC_V_tb.sh [-reset_log]\n\
Usage: RISC_V_tb.sh [-keep_index]\n\
Usage: RISC_V_tb.sh [-noclean_files]\n\n\
