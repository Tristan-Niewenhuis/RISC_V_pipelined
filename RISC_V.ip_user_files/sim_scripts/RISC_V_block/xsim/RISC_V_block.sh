...
#
# Script generated by Vivado on Wed Aug 26 21:52:20 -0600 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RISC_V_block.sh
...
#
# Usage        : RISC_V_block.sh
#                RISC_V_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RISC_V_block.sh [-rerun]
#                RISC_V_block.sh [-reset_run]
#                RISC_V_block.sh [-clean]
#                RISC_V_block.sh [-reset_log]
#                RISC_V_block.sh [-help]
#
...
# script info
echo -e "RISC_V_block.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RISC_V_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_bram_ctrl_v4_1_14 -L blk_mem_gen_v8_4_13 -L axi_lite_ipif_v3_1_0 -L interrupt_control_v3_2_0 -L axi_gpio_v2_0_38 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_37 -L fifo_generator_v13_2_15 -L axi_data_fifo_v2_1_37 -L axi_crossbar_v2_1_39 -L proc_sys_reset_v5_0_17 -L axi_protocol_converter_v2_1_38 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RISC_V_block xil_defaultlib.RISC_V_block xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RISC_V_block -key {Behavioral:sim_1:Functional:RISC_V_block} -tclbatch cmd.tcl -protoinst "protoinst_files/RISC_V_block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RISC_V_block.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RISC_V_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RISC_V_block.sh [-help]\n\
Usage: RISC_V_block.sh [-step]\n\
Usage: RISC_V_block.sh [-lib_map_path]\n\
Usage: RISC_V_block.sh [-rerun]\n\
Usage: RISC_V_block.sh [-reset_run]\n\
Usage: RISC_V_block.sh [-clean]\n\
Usage: RISC_V_block.sh [-reset_log]\n\
Usage: RISC_V_block.sh [-keep_index]\n\
Usage: RISC_V_block.sh [-noclean_files]\n\n\
